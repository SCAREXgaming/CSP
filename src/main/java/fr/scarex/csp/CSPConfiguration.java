...
public class CSPConfiguration implements IModGuiFactory
{
    ...
    public static byte productionUpgradeStackSize = 12;
    ...
    public static void syncConfig() {
        ...
        productionUpgradeStackSize = (byte) CONFIG.getInt("productionUpgradeStackSize", Configuration.CATEGORY_GENERAL, 12, 0, 64, "Maximum of production upgrades to reach 200% production");
