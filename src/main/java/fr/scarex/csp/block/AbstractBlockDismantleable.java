...
public abstract class AbstractBlockDismantleable extends AbstractBlock implements IDismantleable
{
    protected AbstractBlockDismantleable(Material m) {
        super(m);
    }
    ...
    public NBTTagCompound getItemStackTag(World world, int x, int y, int z) {
        if (world.getTileEntity(x, y, z) instanceof AbstractCSPTileEntity) {
            NBTTagCompound comp = new NBTTagCompound();
            ((AbstractCSPTileEntity) world.getTileEntity(x, y, z)).writeExtraCompound(comp);
            return comp;
        }
        return null;
    }
