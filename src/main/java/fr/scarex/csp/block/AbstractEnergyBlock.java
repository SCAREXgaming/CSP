...
public abstract class AbstractEnergyBlock extends AbstractBlock implements IDismantleable
{
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack stack) {
        if (stack.getTagCompound() != null) ((AbstractTileEntityEnergy) world.getTileEntity(x, y, z)).readExtraCompound(stack.getTagCompound());
    }
